...
const std::vector<Metric> Metrics::METRICS = {
    Metric(V1 | V2 | V3 | V4 | V5, 0, 48,
           "engine[0].exhaust_gas_temperature[0]"),
    Metric(V1 | V2 | V3 | V4 | V5, 1, 49,
           "engine[0].exhaust_gas_temperature[1]"),
    Metric(V1 | V2 | V3 | V4 | V5, 2, 50,
           "engine[0].exhaust_gas_temperature[2]"),
    Metric(V1 | V2 | V3 | V4 | V5, 3, 51,
           "engine[0].exhaust_gas_temperature[3]"),
    Metric(V1 | V2 | V3 | V4 | V5, 4, 52,
           "engine[0].exhaust_gas_temperature[4]"),
    Metric(V1 | V2 | V3 | V4 | V5, 5, 53,
           "engine[0].exhaust_gas_temperature[5]"),
    Metric(V1 | V2 | V3 | V4 | V5, 6, 54,
           "engine[0].turbine_inlet_temperature[0]"),
    Metric(V1 | V2 | V3 | V4 | V5, 7, 55,
           "engine[0].turbine_inlet_temperature[1]"),

    Metric(V1 | V2 | V3 | V4 | V5, 8, "engine[0].cylinder_head_temperature[0]"),
    Metric(V1 | V2 | V3 | V4 | V5, 9, "engine[0].cylinder_head_temperature[1]"),
    Metric(V1 | V2 | V3 | V4 | V5, 10,
           "engine[0].cylinder_head_temperature[2]"),
    Metric(V1 | V2 | V3 | V4 | V5, 11,
           "engine[0].cylinder_head_temperature[3]"),
    Metric(V1 | V2 | V3 | V4 | V5, 12,
           "engine[0].cylinder_head_temperature[4]"),
    Metric(V1 | V2 | V3 | V4 | V5, 13,
           "engine[0].cylinder_head_temperature[5]"),
    Metric(V1 | V2 | V3 | V4 | V5, 14,
           "engine[0].cylinder_head_temperature_cooling_rate"),
    ...
    Metric(V1 | V2 | V3 | V4 | V5, 18,
           "engine[0].compressor_discharge_temperature"),
    ...
    Metric(V1 | V2 | V3 | V4 | V5, 22, "engine[0].fuel_used[0]",
           ScaleFactor::TEN_IF_GPH),
    Metric(V1 | V2 | V3 | V4 | V5, 23, "engine[0].fuel_flow[0]",
           ScaleFactor::TEN_IF_GPH),
    ...
    Metric(V1 | V2 | V3 | V4 | V5, 40, "engine[0].manifold_pressure",
           ScaleFactor::TEN),
